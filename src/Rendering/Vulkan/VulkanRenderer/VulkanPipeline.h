...
private:
	...
	#define SIMPLE_GEOMETRY_VERTEX_SHADER		"VulkanShaders/SimpleGeometry.vert.glsl.spv"
	#define SIMPLE_GEOMETRY_FRAGMENT_SHADER		"VulkanShaders/SimpleGeometry.frag.glsl.spv"
